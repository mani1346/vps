            ...
            <div class="auth-page-card register-card" style="max-width: 550px; width: 100%;">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="fname" placeholder="John" v-model="first_name" />
                    </div>
                     <div class="col-md-6 mb-3">
                        <label for="lname" class="form-label">Last Name</label>
                        <input type="text" class="form-control" id="lname" placeholder="Doe" v-model="last_name" />
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="vehicle" placeholder="XX00XX0000" v-model="vehicle_number" />
                    </div>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="password" class="form-label">Password</label>
                     <div class="input-group">
                        ...
                        <input type="password" class="form-control" id="password" placeholder="Choose a strong password" v-model="password" />
                    </div>
                </div>
                <!-- END OF HTML FIX -->
                
                <button class="btn btn-success w-100" @click="submitRegister">Create Account</button>
