export default {
    ...
    template: `
    <div> <!-- Root element wrapper to fix Vue 2 error -->
        ...
        <div class="container-fluid mt-4">
            ...
            <!-- MODAL 1: View/Delete Parking Spot -->
            ...
            <!-- Add/Edit Lot Modals (No changes here) -->
    ...
    </div> <!-- Root element wrapper ends here -->
    `,
    data() {
        return {
            parkingLots: [],
