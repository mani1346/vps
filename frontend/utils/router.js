...
import AdminParkingLotsPage from "../pages/AdminParkingLotsPage.js";
...
const routes = [
    ...
    { path: '/admin/parking-lots', component: AdminParkingLotsPage, meta: { requiresLogin: true, role: "admin" } },
    { path: '/admin/users', component: AdminUsersPage, meta: { requiresLogin: true, role: "admin" } },
